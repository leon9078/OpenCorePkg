...
package() {
  ...
  mkdir "${dstdir}/Utilities/BaseTools/Windows" || exit 1
  if [ "$(unamer)" = "Windows" ]; then
    ...
    cp "${selfdir}/UDK/BaseTools/Bin/Win32/GenFfs.exe" "${dstdir}/Utilities/BaseTools/Windows" || exit 1
    cp "${selfdir}/UDK/BaseTools/Bin/Win32/GenSec.exe" "${dstdir}/Utilities/BaseTools/Windows" || exit 1
  fi
